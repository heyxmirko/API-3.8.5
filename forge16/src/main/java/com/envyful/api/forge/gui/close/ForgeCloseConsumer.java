...
public class ForgeCloseConsumer implements CloseConsumer<ForgeEnvyPlayer, ServerPlayerEntity> {
    ...
    public static class Builder implements CloseConsumer.Builder<ForgeEnvyPlayer, ServerPlayerEntity> {
        ...
        @Override
        public CloseConsumer.Builder<ForgeEnvyPlayer, ServerPlayerEntity> delayTicks(int delayTicks) {
            this.delayTicks = delayTicks;
            return this;
        }

        @Override
        public CloseConsumer.Builder<ForgeEnvyPlayer, ServerPlayerEntity> predicate(Predicate<ForgeEnvyPlayer> predicate) {
            this.predicate = predicate;
            return this;
        }

        @Override
        public CloseConsumer.Builder<ForgeEnvyPlayer, ServerPlayerEntity> handler(Consumer<ForgeEnvyPlayer> player) {
            this.handler = player;
            return this;
        }

        @Override
        public CloseConsumer.Builder<ForgeEnvyPlayer, ServerPlayerEntity> async(boolean async) {
            this.async = async;
            return this;
        }

        @Override
        public CloseConsumer<ForgeEnvyPlayer, ServerPlayerEntity> build() {
